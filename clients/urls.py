...
urlpatterns = [
    ...
    path(
        'client/<int:pk>/print/document/<str:doc_type>/',
    ...
    path('requirements/<int:pk>/edit/', views.edit_client_document_requirement, name='client_document_requirement_edit'),
    path('requirements/<int:pk>/delete/', views.delete_client_document_requirement, name='client_document_requirement_delete'),
    path(
        'document/<int:doc_id>/confirm-wezwanie/',
        views.confirm_wezwanie_parse,
        name='confirm_wezwanie_parse',
    ),
    path('document/<int:doc_id>/preview/', views.document_preview, name='document_preview'),
    ...
    path('onboarding/<str:token>/document/<int:doc_id>/preview/', views.onboarding_document_preview, name='onboarding_document_preview'),
