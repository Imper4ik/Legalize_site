...
class Client(SoftDeleteModel):
    ...
    def get_document_checklist(
        ...
        from clients.models._client_checklist import build_document_checklist
        return build_document_checklist(self, check_file_existence, requirements_cache, case)
    ...
    def get_health_alerts(self, document_status_list: list[dict[str, Any]] | None = None) -> list[dict[str, Any]]:
        from clients.models._client_health import build_health_alerts
        return build_health_alerts(self, document_status_list)
    def get_automatic_checks(self, document_status_list: list[dict[str, Any]] | None = None) -> list[dict[str, Any]]:
        from clients.models._client_health import build_automatic_checks
        return build_automatic_checks(self, document_status_list)
