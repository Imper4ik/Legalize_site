...
urlpatterns = [
    ...
    path('quick-update/<int:submission_id>/', views.submission_quick_update, name='submission_quick_update'),
    path('quick-delete/<int:submission_id>/', views.submission_quick_delete, name='submission_quick_delete'),
